...
describe "User pages" do
  ...
  describe "index" do
    ...
    describe "delete links" do
      describe "as a non admin user" do
        ...
        it { should_not have_link('delete', href: user_path(non_admin)) }
      end
      ...
      describe "as an admin user" do
        ...
        #it "admin user should not be able to delete itself" do
        #end.
  ...
  describe "signup" do
    ...
    end  # describe signup with invalid information
    ...
    end  # describe signup with valid information
  ...
  end # describe edit profile page
